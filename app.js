...
if (drawer && tab) {
  ...
  ['btn-rtp', 'btn-size', 'btn-deposit', 'btn-buy-bonus', 'btn-help', 'btn-rules', 'btn-simulate', 'btn-math', 'btn-seo', 'btn-force-extreme', 'btn-force-wild', 'btn-web-push'].forEach(id => {
...
const { alphaSrc, IS_IOS } = require("video-format");   // WebM → HEVC-alpha .mp4 on Safari
...
Object.assign(exports, { IS_IOS, USE_HEVC_ALPHA, alphaSrc, initAlphaVideos });
