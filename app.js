...
const { alphaSrc } = require("video-format");   // warm the right format (Safari uses .mp4 for alpha)
...
Object.assign(exports, { USE_HEVC_ALPHA, alphaSrc, initAlphaVideos });
